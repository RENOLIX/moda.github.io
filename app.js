...
function header(){
  ...
  <header class="header"><div class="container nav">
    ...
    <nav class="nav-links" aria-label="Navigation principale">
      <a href="index.html">Accueil</a><a href="index.html#collection">Collection</a><a href="index.html#nouveautes">Nouveautés</a>
    </nav>
...
function renderHome(){
  document.querySelector('#app').innerHTML = `${header()}
    <main><section class="hero-full"><img class="hero-full__image" src="public/hero-moda.png" alt="Nouvelle collection homme Moda Afair"><div class="hero-full__shade"></div><div class="container hero-full__content"><span class="hero-full__eyebrow">Nouvelle collection</span><h1>MODA<br>AFAIR</h1><p>Baskets & vêtements homme</p><a class="hero-full__button" href="#collection">DÉCOUVRIR <span>→</span></a></div></section>
    <section class="section" id="collection"><div class="container"><div class="section-head"><div><span class="eyebrow">La Maison Moda</span><h2>Notre Collection</h2></div><p>Des pièces pensées pour révéler votre style.</p></div><div class="category-grid"><a class="category sneakers" href="#nouveautes"><div class="category-copy"><h3>BASKETS</h3><p>Baskets urbaines pour toutes les occasions</p></div></a><a class="category clothes" href="#nouveautes"><div class="category-copy"><h3>VÊTEMENTS</h3><p>Des essentiels modernes et raffinés</p></div></a><a class="category jackets" href="#nouveautes"><div class="category-copy"><h3>VESTES</h3><p>Des coupes fortes pour chaque saison</p></div></a><a class="category cargo" href="#nouveautes"><div class="category-copy"><h3>PANTALONS</h3><p>Des lignes urbaines et confortables</p></div></a><a class="category ensembles" href="#nouveautes"><div class="category-copy"><h3>ENSEMBLES</h3><p>Un style complet sans effort</p></div></a><a class="category accessories" href="#nouveautes"><div class="category-copy"><h3>ACCESSOIRES</h3><p>Les détails qui terminent le look</p></div></a></div></div></section>
