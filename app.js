...
function renderHome(){
  document.querySelector('#app').innerHTML = `${header()}
    ...
    <section class="promotions reveal"><span class="eyebrow">Offres du moment</span><h2>Nos Promotions</h2><p>Profitez de nos réductions sur une sélection de pièces.</p><div class="promotion-empty">Aucune promotion en ce moment. Revenez bientôt !</div></section>
