...
function header(){
  ...
  <header class="header"><div class="container nav">
    <button class="icon-btn menu-btn" aria-label="Ouvrir le menu" onclick="document.body.classList.toggle('menu-open')">☰</button>
    ...
    <div class="nav-actions"><a class="icon-btn" href="panier.html" aria-label="Voir le panier">🛒<span class="cart-count">0</span></a></div>
  </div></header>`;
}
...
function renderHome(){
  document.querySelector('#app').innerHTML = `${header()}
    <main><section class="hero"><div class="container"><div class="hero-copy"><span class="eyebrow">Nouvelle collection 2026</span><h1>Le style prend position.</h1><p>Baskets et essentiels masculins sélectionnés pour ceux qui avancent avec assurance. Des coupes fortes, des couleurs franches, zéro superflu.</p><a class="btn" href="#nouveautes">Découvrir</a><a class="btn btn-ghost" href="#collection">Les catégories</a></div></div></section>
    <section class="section" id="collection"><div class="container"><div class="section-head"><div><span class="eyebrow">La maison Moda</span><h2>Notre collection</h2></div><p>Des pièces conçues pour construire une garde-robe urbaine, polyvalente et résolument masculine.</p></div><div class="category-grid"><a class="category sneakers" href="#nouveautes"><h3>Baskets</h3><span>Explorer →</span></a><a class="category clothes" href="#nouveautes"><h3>Vêtements</h3><span>Explorer →</span></a><a class="category jackets" href="#nouveautes"><h3>Vestes</h3><span>Explorer →</span></a></div></div></section>
